...
function callCredits () {
    story.startCutscene(function () {
        ...
        creditsCharacter(assets.animation`sabuR`, assets.animation`sabuR`, "SABUROU SHIRAISHI", "Programmer\\nArtist/Designer\\nWriter\\nLevel Designer\\nOriginal Idea")
        creditsCharacter(assets.animation`yasuda`, assets.animation`yasuda`, "TAROU KURODA", "Level Designer\\nPlay Tester\\nMain Assistant")
        creditsCharacter(assets.animation`ryoheiR`, assets.animation`ryoheiR`, "RYOUHEI NAKAMURA", "Level Designer\\nPlay Tester\\nCreative Ideas")
        creditsCharacter(assets.animation`nagiidleR`, assets.animation`nagirunR`, "With special thanks to...", "abc")
        creditsCharacter(assets.animation`haruR`, assets.animation`haruR`, "HARU HIDAKA", "abc")
        creditsCharacter(assets.animation`nejiR`, assets.animation`nejiR`, "NEJI-SENSEI", "abc")
        creditsCharacter(assets.animation`daisuke`, assets.animation`daisuke`, "DAISUKE YOSHINAGA", "abc")
        if (diddlydingus == 1) {
